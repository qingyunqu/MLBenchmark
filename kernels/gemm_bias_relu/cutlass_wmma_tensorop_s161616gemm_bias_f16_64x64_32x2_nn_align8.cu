...
void initialize_cutlass_wmma_tensorop_s161616gemm_bias_f16_64x64_32x2_nn_align8(Manifest &manifest) {
  ...
  manifest.append(new GemmBiasOperation<Operation_cutlass_wmma_tensorop_s161616gemm_bias_f16_64x64_32x2_nn_align8>("cutlass_wmma_tensorop_s161616gemm_bias_f16_64x64_32x2_nn_align8", EpilogueEnum::Relu));
#endif
