...
void initialize_cutlass_tensorop_h884gemm_bias_64x64_32x2_tt_align4(Manifest &manifest) {
  ...
  manifest.append(new GemmBiasOperation<Operation_cutlass_tensorop_h884gemm_bias_64x64_32x2_tt_align4>("cutlass_tensorop_h884gemm_bias_64x64_32x2_tt_align4", EpilogueEnum::Relu));
