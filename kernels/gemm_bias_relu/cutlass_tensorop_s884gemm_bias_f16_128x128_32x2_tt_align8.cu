...
void initialize_cutlass_tensorop_s884gemm_bias_f16_128x128_32x2_tt_align8(Manifest &manifest) {
  ...
  manifest.append(new GemmBiasOperation<Operation_cutlass_tensorop_s884gemm_bias_f16_128x128_32x2_tt_align8>("cutlass_tensorop_s884gemm_bias_f16_128x128_32x2_tt_align8", EpilogueEnum::Relu));
