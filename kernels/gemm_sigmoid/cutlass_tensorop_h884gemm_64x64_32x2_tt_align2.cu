...
void initialize_cutlass_tensorop_h884gemm_64x64_32x2_tt_align2(Manifest &manifest) {
  ...
  manifest.append(new GemmOperation<Operation_cutlass_tensorop_h884gemm_64x64_32x2_tt_align2>("cutlass_tensorop_h884gemm_64x64_32x2_tt_align2", EpilogueEnum::Sigmoid));
