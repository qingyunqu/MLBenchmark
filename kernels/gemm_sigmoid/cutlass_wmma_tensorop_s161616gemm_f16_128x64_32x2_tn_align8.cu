...
void initialize_cutlass_wmma_tensorop_s161616gemm_f16_128x64_32x2_tn_align8(Manifest &manifest) {
  ...
  manifest.append(new GemmOperation<Operation_cutlass_wmma_tensorop_s161616gemm_f16_128x64_32x2_tn_align8>("cutlass_wmma_tensorop_s161616gemm_f16_128x64_32x2_tn_align8", EpilogueEnum::Sigmoid));
#endif
