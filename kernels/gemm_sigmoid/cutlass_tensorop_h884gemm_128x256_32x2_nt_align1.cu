...
void initialize_cutlass_tensorop_h884gemm_128x256_32x2_nt_align1(Manifest &manifest) {
  ...
  manifest.append(new GemmOperation<Operation_cutlass_tensorop_h884gemm_128x256_32x2_nt_align1>("cutlass_tensorop_h884gemm_128x256_32x2_nt_align1", EpilogueEnum::Sigmoid));
