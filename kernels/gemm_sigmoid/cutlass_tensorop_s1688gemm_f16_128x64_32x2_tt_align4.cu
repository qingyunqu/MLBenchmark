...
void initialize_cutlass_tensorop_s1688gemm_f16_128x64_32x2_tt_align4(Manifest &manifest) {
  ...
  manifest.append(new GemmOperation<Operation_cutlass_tensorop_s1688gemm_f16_128x64_32x2_tt_align4>("cutlass_tensorop_s1688gemm_f16_128x64_32x2_tt_align4", EpilogueEnum::Sigmoid));
