...
void initialize_cutlass_tensorop_h1688gemm_256x128_32x2_tn_align4(Manifest &manifest) {
  ...
  manifest.append(new GemmOperation<Operation_cutlass_tensorop_h1688gemm_256x128_32x2_tn_align4>("cutlass_tensorop_h1688gemm_256x128_32x2_tn_align4", EpilogueEnum::Grelu));
