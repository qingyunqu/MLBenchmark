...
void initialize_cutlass_tensorop_h884gemm_128x64_32x2_nt_align1(Manifest &manifest) {
  ...
  manifest.append(new GemmOperation<Operation_cutlass_tensorop_h884gemm_128x64_32x2_nt_align1>("cutlass_tensorop_h884gemm_128x64_32x2_nt_align1", EpilogueEnum::Grelu));
