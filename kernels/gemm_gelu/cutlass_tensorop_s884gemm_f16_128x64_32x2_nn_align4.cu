...
void initialize_cutlass_tensorop_s884gemm_f16_128x64_32x2_nn_align4(Manifest &manifest) {
  ...
  manifest.append(new GemmOperation<Operation_cutlass_tensorop_s884gemm_f16_128x64_32x2_nn_align4>("cutlass_tensorop_s884gemm_f16_128x64_32x2_nn_align4", EpilogueEnum::Grelu));
