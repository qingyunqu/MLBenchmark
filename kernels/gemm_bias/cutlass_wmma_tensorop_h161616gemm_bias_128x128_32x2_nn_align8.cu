...
void initialize_cutlass_wmma_tensorop_h161616gemm_bias_128x128_32x2_nn_align8(Manifest &manifest) {
  ...
  manifest.append(new GemmBiasOperation<Operation_cutlass_wmma_tensorop_h161616gemm_bias_128x128_32x2_nn_align8>("cutlass_wmma_tensorop_h161616gemm_bias_128x128_32x2_nn_align8", EpilogueEnum::None));
#endif
