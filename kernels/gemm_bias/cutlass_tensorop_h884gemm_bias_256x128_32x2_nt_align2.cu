...
void initialize_cutlass_tensorop_h884gemm_bias_256x128_32x2_nt_align2(Manifest &manifest) {
  ...
  manifest.append(new GemmBiasOperation<Operation_cutlass_tensorop_h884gemm_bias_256x128_32x2_nt_align2>("cutlass_tensorop_h884gemm_bias_256x128_32x2_nt_align2", EpilogueEnum::None));
